...
export const SILHOUETTES: Silhouette[] = [
  ...
  },
  {
    ...
    year: 1996,
    description: 'Inspired by the Rising Sun of Japan, the AJ12 became legend when MJ scored 38 points in Game 5 of the 1997 Finals while visibly ill. The Flu Game shoe.',
    ...
    pes: [
      {
        ...
        summary: 'One of the purest shooters in NBA history wore this white and Celtics green PE during Boston\'s 2008 championship run. Clean colorway. Cleaner jump shot. Banner season.',
      },
      {
        athlete: 'Gary Payton',
        peName: 'The Glove PE',
        ...
        summary: 'The best defensive point guard of his generation. Gary Payton\'s AJ12 PE in SuperSonics black and green is as relentless and locked-in as his on-ball defense.',
      },
      {
        athlete: 'Carmelo Anthony',
        peName: 'Melo PE',
        ...
        summary: 'Fresh off a historic rookie year, Melo received this sleek black and gold AJ12 in his second season. Already a cornerstone of the Jordan Brand family before turning 21.',
      },
      {
        athlete: 'Mike Bibby',
        peName: 'Bibby PE',
        ...
        summary: 'Mike Bibby orchestrated one of the most thrilling Kings dynasties from the point. His royal purple AJ12 PE is one of the rarest and most sought-after exclusives of the era.',
      },
    ],
  },
];
